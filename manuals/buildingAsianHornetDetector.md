...
```scp /PATH/TO/LOCAL/best.pt vespcv@RASPBERRYIP:/home/vespcv/vespcv```
If you have not trained your own model you can use: [best.pt](https://github.com/vespCV/hornet3000/blob/main/yolov10nModel/weights/best.pt)
